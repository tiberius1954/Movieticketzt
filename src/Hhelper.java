...
//	public Color slilla = new Color(103, 97, 224);	 
	...
	public Border borders = BorderFactory.createLineBorder(Color.red, 1);	
	...
	public Font textf2 = new Font("Tahoma", Font.BOLD, 14);	
	...
	public static void setSelectedValue(JComboBox comboBox, int value) {
		...
		if ("movie".equals(gn)) {
			for (int i = 0; i < comboBox.getItemCount(); i++) {
				movie = (Movie) comboBox.getItemAt(i);
...
//			tabla.setSelectionBackground(vvzold);		
	...
	public JTableHeader madeheader(JTable table) {
		...
		Font headerFont = new Font("tahoma", 1, 14);
	...
	public JComboBox cbcombo() {
		...
		//ccombo.setBorder(BorderFactory.createMatteBorder(1, 1, 3, 3, Color.LIGHT_GRAY));
		return ccombo;
	}
	...
	public void iconhere(JFrame that) {
		ImageIcon ImageIcon = new ImageIcon(ClassLoader.getSystemResource("images/chearx.png"));
	...
	public boolean correcttime(String stime) {
		...
		try {
			...
			Date bTime = sdf.parse("00:00");
			Date eTime = sdf.parse("24:00");			
